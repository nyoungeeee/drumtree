...
<link rel="stylesheet" type="text/css" href="resources\CSS\Style_Admin_Notice.css">
<script type="text/javascript" src="resources\JavaScript\Menubar.js"></script>
<script type="text/javascript" src="resources\JavaScript\Func_Admin_Notice.js"></script>
