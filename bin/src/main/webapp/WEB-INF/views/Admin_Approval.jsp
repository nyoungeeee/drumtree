...
<link rel="stylesheet" type="text/css" href="resources\CSS\Style_Admin_Approval.css">
<script type="text/javascript" src="resources\JavaScript\Menubar.js"></script>
<script type="text/javascript" src="resources\JavaScript\Func_Admin_Approval.js"></script>
